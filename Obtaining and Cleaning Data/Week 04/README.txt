refer README_ORIGIN.txt for initial dataset explanations.

==================================================================
Human Activity Recognition Using Smartphones Dataset
Finding Average from existing data set
==================================================================
...
-------
Measurements only in the mean were taken and stored in the variable meanData.
Here mean data is any column with the name mean in it. it can be at the beginning or middle of the name of reading.
--------
To get the average of each activity of each subject, the masterDataSet was first subsetted into different combinations (180 combinations) of SubjectID + Activity pairs using spilt function.
